...
<f type="MSG" name="msg">
    ...
    <f type="BIT_SET" name="bitmap" bitMapPacker="IfbBitmapPacker" len="16">
        ...
        <f type="LEN_VAL" tagNum="58" name="field_58" lengthPacker="EbcdicDecimalLengthPacker" bodyPacker="LiteralBodyPacker" maxLen="999" childTagLen="2" childTagPacker="EbcdicDecimalTagPacker">
