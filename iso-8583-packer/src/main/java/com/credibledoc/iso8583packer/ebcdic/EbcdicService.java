...
/**
 * Static service for conversions of <a href="https://en.wikipedia.org/wiki/EBCDIC">EBCDIC</a> data format.
 * 
 * @author Kyrylo Semenko
 */
public class EbcdicService {
    
    private EbcdicService() {
        throw new PackerRuntimeException("Please do not instantiate the static helper.");
    }

    private static final byte[] ASCII2EBCDIC = new byte[] {
    ...
    private static final byte[] EBCDIC2ASCII = new byte[] {
            (byte)0x0,  (byte)0x1,  (byte)0x2,  (byte)0x3,
    ...
    static String ebcdicToAscii(byte[] e, int offset, int len, Charset charset) {
        return new String(ebcdicToAsciiBytes(e, offset, len), charset);
    }

    private static byte[] ebcdicToAsciiBytes(byte[] e, int offset, int len) {
        byte[] a = new byte[len];
        for (int i=0; i<len; i++)
