...
import org.credibledoc.substitution.doc.module.substitution.exception.SubstitutionDocRuntimeException;
...
public class ModulesActivityTransformer implements Transformer {
    ...
    static {
        ...
        packagePrefixToModuleName.put("org.credibledoc.substitution.doc", SubstitutionDocMain.SUBSTITUTION_DOC);
