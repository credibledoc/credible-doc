...
public class ReportDocumentRepository {
     ...
     * {@link org.credibledoc.substitution.doc.visualizer.VisualizerService} will read line by
     * line source files and for each line will try to apply all
     * {@link org.credibledoc.substitution.doc.transformer.LineProcessor}s related with all reportDocuments.
     ...
     * current {@link org.credibledoc.substitution.doc.transformer.LineProcessor}. Returned
     ...
     * {@link org.credibledoc.substitution.doc.visualizer.VisualizerService} createReports method.
     */
