...
In this case will be merged log files from the `/var/log/temp` folder. And will be used the
`/var/log/combiner/three-app.properties` configuration file. In this case you should create
